<?php
if ( ! function_exists( 'coyote_edge_init_google_fonts_array' ) ) {
	function coyote_edge_init_google_fonts_array() {

		global $coyote_edge_fonts_array;
		$coyote_edge_fonts_array =
			array(
				0   =>
					array(
	...
	add_action('after_setup_theme', 'coyote_edge_init_google_fonts_array');
}