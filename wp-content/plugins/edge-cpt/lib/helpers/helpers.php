...
if(!function_exists('edgt_core_init_shortcode_loader')) {
	...
	add_action('coyote_edge_shortcode_loader', 'edgt_core_init_shortcode_loader');
}
...
if(!function_exists('edgt_core_portfolio_ajax_load_more')){
	...
	if (!empty($_POST['rowHeight'])) {
        $shortcode_params['row_height'] = $_POST['rowHeight'];
    }
...
if(!function_exists('edgt_core_string_ends_with')) {
	/**
	 ...
	 * @return bool
	 */
	function edgt_core_string_ends_with($haystack, $needle) {
		if($haystack !== '' && $needle !== '') {
...
if(!function_exists('edgt_core_filter_suffix')) {
	/**
	 ...
	 * @return string
	 */
	function edgt_core_filter_suffix($value, $suffix) {
		if($value !== '' && edgt_core_string_ends_with($value, $suffix)) {
 ...
 * @return bool
 */
function coyote_edge_url_exists($url) {
