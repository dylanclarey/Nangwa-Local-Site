<div class="edgtf-blog-list-holder <?php echo esc_attr($holder_classes) ?>">
	...
	$html = '';
		if($query_result->have_posts()):
			if ($type == 'boxes'){
				$html .= coyote_edge_get_shortcode_module_template_part('templates/title-boxes', 'blog-list', '', $params);
			}
		while ($query_result->have_posts()) : $query_result->the_post();
			$html .= coyote_edge_get_shortcode_module_template_part('templates/'.$type, 'blog-list', '', $params);
		endwhile;
		print $html;
		else: ?>
