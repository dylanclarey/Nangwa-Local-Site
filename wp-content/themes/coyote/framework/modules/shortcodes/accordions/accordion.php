<?php
namespace CoyoteEdge\Modules\Shortcodes\Accordion;
...
class Accordion implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Accordion', 'coyote'),
			'base' => $this->base,
			...
			'params' => array(
				...
				array(
					...
					'param_name' => 'style',
					'value' => array(
						esc_html__('Accordion', 'coyote') => 'accordion',
						esc_html__('Toggle', 'coyote') => 'toggle'
					),
					'save_always' => true
				),
				array(
	...
	public function render($atts, $content = null) {
		...
		$output .= coyote_edge_get_shortcode_module_template_part('templates/accordion-holder-template','accordions', '', $params);
