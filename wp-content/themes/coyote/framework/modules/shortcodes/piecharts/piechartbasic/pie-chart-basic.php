<?php
namespace CoyoteEdge\Modules\Shortcodes\PieCharts\PieChartBasic;
...
class PieChartBasic implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Pie Chart', 'coyote'),
			'base' => $this->getBase(),
			...
			'params' => array(
				array(
					'type' => 'dropdown',
					'heading' => esc_html__('Type of Central text','coyote'),
					'param_name' => 'type_of_central_text',
					'value' => array(
						esc_html__('Percent','coyote')  => 'percent',
	...
	public function render($atts, $content = null) {
		...
		$html = coyote_edge_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);
