<?php
namespace CoyoteEdge\Modules\Shortcodes\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Pie Chart With Icon', 'coyote'),
			'base' => $this->getBase(),
			...
			'params' => array_merge(
				array(
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Size(px)', 'coyote'),
						'param_name' => 'size',
						'group' => esc_html__('Design Options','coyote'),
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Margin below chart (px)', 'coyote'),
                    ...
                    array(
                        'type' => 'colorpicker',
                        'heading' => esc_html__('Active Color', 'coyote'),
                        'param_name' => 'active_color',
						'group' => esc_html__('Design Options','coyote'),
                    ),
                    array(
                        'type' => 'colorpicker',
                        'heading' => esc_html__('Inactive Color', 'coyote'),
				...
				array(
					array(
						...
						'dependency' => Array('element' => 'icon_pack', 'value' => coyote_edge_icon_collections()->getIconCollectionsKeys()),
						'group' => esc_html__('Design Options','coyote'),
					),
					array(
						'type' => 'textfield',
	...
	public function render($atts, $content = null)
	{
		...
		$html = coyote_edge_get_shortcode_module_template_part('templates/pie-chart-with-icon', 'piecharts/piechartwithicon', '', $params);
	...
	private function getPieChartIcon($params) {
		...
		$pie_chart_icon = coyote_edge_icon_collections()->renderIcon( $params[$icon], $params['icon_pack'], $iconStyles );
