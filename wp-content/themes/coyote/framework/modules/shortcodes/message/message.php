<?php
namespace CoyoteEdge\Modules\Shortcodes\Message;
...
class Message implements ShortcodeInterface	{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Message', 'coyote'),
			'base' => $this->base,
			...
			'params' => array_merge(
				...
				\CoyoteEdgeIconCollections::get_instance()->getVCParamsArray(array('element' => 'type', 'value' => 'with_icon')),
				array(
					array(
						'type' => 'colorpicker',
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Border Width (px)', 'coyote'),
						'param_name' => 'border_width',
						'description' => esc_html__('Default value is 0','coyote'),
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Color', 'coyote'),
						'param_name'  => 'close_icon_color',
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Hover Color', 'coyote'),
	...
	public function render($atts, $content = null) {
		...
		$html = coyote_edge_get_shortcode_module_template_part('templates/message-holder-template', 'message', '', $params);
