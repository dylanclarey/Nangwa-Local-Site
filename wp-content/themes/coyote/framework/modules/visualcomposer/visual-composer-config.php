...
if ( ! function_exists('coyote_edge_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function coyote_edge_configure_visual_composer() {
	...
	add_action('vc_after_init', 'coyote_edge_configure_visual_composer');

}


if ( ! function_exists('coyote_edge_configure_visual_composer_grid_elemets') ) {
	...
	function coyote_edge_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'coyote_edge_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('coyote_edge_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function coyote_edge_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'coyote_edge_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Edgtf_Section_Holder extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Edgtf_Section_Item extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Edgtf_Text_Slider extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Edgtf_Interactive_Items extends WPBakeryShortCodesContainer {}
    class WPBakeryShortCode_Edgtf_Restaurant_Menu extends WPBakeryShortCodesContainer {}
}
...
/*** Row ***/
if ( ! function_exists('coyote_edge_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function coyote_edge_vc_row_map()
	{

		$animations = array(
			esc_html__('No animation','coyote') => '',
			esc_html__('Elements Shows From Left Side','coyote') 	=>	'edgtf-element-from-left',
			esc_html__('Elements Shows From Right Side','coyote')	=> 	'edgtf-element-from-right',
			esc_html__('Elements Shows From Top Side','coyote')	=>	'edgtf-element-from-top',
			esc_html__('Elements Shows From Bottom Side','coyote')	=>	'edgtf-element-from-bottom',
			esc_html__('Elements Shows From Fade','coyote')		=>	'edgtf-element-from-fade'
		);

		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('Row Type','coyote'),
			'param_name' => 'row_type',
			'value' => array(
				esc_html__('Row','coyote') => 'row',
				esc_html__('Parallax','coyote') => 'parallax'
			)
		));

		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('Content Width','coyote'),
			'param_name' => 'content_width',
			'value' => array(
				esc_html__('Full Width','coyote') => 'full-width',
				esc_html__('In Grid','coyote') => 'grid'
			)
		));

		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('Header Style','coyote'),
			'param_name' => 'header_style',
			'value' => array(
				esc_html__('Default','coyote') => '',
				esc_html__('Light','coyote') => 'edgtf-light-header',
				esc_html__('Dark','coyote') => 'edgtf-dark-header'
			),
			'dependency' => Array('element' => 'row_type', 'value' => array('row', 'parallax'))
		));
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Anchor ID','coyote'),
			'param_name' => 'anchor',
			'value' => '',
			'description' => esc_html__('For example "home"','coyote'),
		));
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('Video Background','coyote'),
			'value' => array(
				esc_html__('No','coyote') => '',
				esc_html__('Yes','coyote') => 'show_video'
			),
			'param_name' => 'video',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('Video Overlay','coyote'),
			'value' => array(
				esc_html__('No','coyote') => '',
				esc_html__('Yes','coyote') => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'heading' => esc_html__('Video Overlay Image (pattern)','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Video Background (webm) File URL','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Video Background (mp4) file URL','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Video Background (ogv) file URL','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'heading' => esc_html__('Video Preview Image','coyote'),
		...
		vc_add_param("vc_row", array(
			'type' => 'dropdown',
			'heading' => esc_html__('Full Screen Height','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('Vertically Align Content In Middle','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Section Height','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'heading' => esc_html__('Parallax Background image','coyote'),
			'param_name' => 'parallax_background_image',
			'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field','coyote'),
			'dependency' => Array('element' => 'row_type', 'value' => array('parallax'))
		));

		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Parallax speed','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('CSS Animation','coyote'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Transition delay (ms)','coyote'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'dropdown',
            'param_name' => 'back_to_top_skin',
            'heading' => esc_html__('Edge Back To Top Skin', 'coyote'),
            'value' => array(
                esc_html__('Default', 'coyote') => 'default',
                esc_html__('Light', 'coyote') => 'light'
            ),
            'save_always' => true,
            'description' => esc_html__('This option defines the skin of the Back To Top Button when it is located over this row.', 'coyote')
        ));
	...
	add_action('vc_after_init', 'coyote_edge_vc_row_map');
}
