...
if(!function_exists('coyote_edge_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function coyote_edge_get_wpml_pages_for_current_page() {
		$wpml_pages_for_current_page = array();

		if(coyote_edge_is_wpml_installed()) {
...
if(!function_exists('coyote_edge_disable_wpml_css')) {
    function coyote_edge_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'coyote_edge_disable_wpml_css');
}