<?php
$filter = esc_attr(coyote_edge_options()->getOptionValue('masonry_filter'));

if($filter == 'yes'){
	$page_category = get_post_meta(coyote_edge_get_page_id(), "edgtf_blog_category_meta", true);
	if(is_category()){
	...
	if (count($categories) > 0) {	?>
		<div class="edgtf-filter-blog-holder">
			<div class="edgtf-filter-blog">
				<ul>
					<li class="edgtf-filter edgtf-active" data-filter="*"><span><?php esc_html_e('All', 'coyote'); ?></span></li>
