 ...
 */
class CoyoteEdgeSocialIconWidget extends CoyoteEdgeWidget {
    /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Edge Social Icon Widget','coyote') // Name
        );
    ...
    protected function setParams() {
        $this->params = array_merge(
            coyote_edge_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Link', 'coyote'),
                    'name' => 'link',

                ),
                array(
                    'type' => 'dropdown',
                    'title' => esc_html__('Target', 'coyote'),
                    'name' => 'target',
                    'options' => array(
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Text Size (px)', 'coyote'),
                    'name' => 'text_size',
                ),
                array(
                    'type' => 'textfield',
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Hover Color', 'coyote'),
                    'name' => 'hover_color',
                ),
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Margin', 'coyote'),
                    'name' => 'margin',
    ...
    public function widget($args, $instance) {
        ...
        <a class="edgtf-social-icon-widget-holder" <?php echo coyote_edge_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php coyote_edge_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
