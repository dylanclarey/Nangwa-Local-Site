...
class HeaderStandard extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = coyote_edge_filter_px(coyote_edge_options()->getOptionValue('menu_area_height_header_standard'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = coyote_edge_options()->getOptionValue('menu_area_in_grid_header_standard') == 'yes' ? true : false;

        $parameters = apply_filters('coyote_edge_header_standard_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        if(get_post_meta($id, 'edgtf_menu_area_background_color_header_standard_meta', true) !== ''){
            ...
            $menuAreaTransparent = coyote_edge_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
                                   coyote_edge_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1';
        }
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'edgtf_menu_area_background_color_header_standard_meta', true) !== ''){
            ...
            $menuAreaTransparent = coyote_edge_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
                                   coyote_edge_options()->getOptionValue('menu_area_background_transparency_header_standard') === '0';
        }
