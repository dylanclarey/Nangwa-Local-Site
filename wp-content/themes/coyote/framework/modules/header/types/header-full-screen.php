...
class HeaderFullScreen extends HeaderType {
    ...
    public function __construct() {
        ...
        $full_screen_type_opener_position = coyote_edge_get_meta_field_intersect('menu_position_header_full_screen');
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = coyote_edge_filter_px(coyote_edge_options()->getOptionValue('menu_area_height_header_full_screen'));
    ...
    public function loadTemplate($parameters = array()) {
		...
		$parameters['menu_area_in_grid'] = coyote_edge_options()->getOptionValue('menu_area_in_grid_header_full_screen') == 'yes' ? true : false;

        $parameters = apply_filters('coyote_edge_header_full_screen_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        if(get_post_meta($id, 'edgtf_menu_area_background_color_header_full_screen_meta', true) !== ''){
            ...
            $menuAreaTransparent = coyote_edge_options()->getOptionValue('menu_area_background_color_header_full_screen') !== '' &&
                                   coyote_edge_options()->getOptionValue('menu_area_background_transparency_header_full_screen') !== '1';
        }
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'edgtf_menu_area_background_color_header_full_screen_meta', true) !== ''){
            ...
            $menuAreaTransparent = coyote_edge_options()->getOptionValue('menu_area_background_color_header_full_screen') !== '' &&
                                   coyote_edge_options()->getOptionValue('menu_area_background_transparency_header_full_screen') === '0';
        }
