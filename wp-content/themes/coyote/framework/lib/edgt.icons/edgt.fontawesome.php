...
class CoyoteEdgeIconsFontAwesome implements iCoyoteEdgeIconCollection {
    ...
    public function setSocialIconsArray() {
		$this->socialIcons = array(
			""                      => "",
			"fa-500px" 				=> esc_html__("500px", 'coyote'),
			"fa-adn"                => esc_html__("ADN", 'coyote'),
			"fa-amazon"				=> esc_html__("Amazon", 'coyote'),
			"fa-android"            => esc_html__("Android", 'coyote'),
			"fa-apple"              => esc_html__("Apple", 'coyote'),
			"fa-behance"            => esc_html__("Behance", 'coyote'),
			"fa-behance-square"     => esc_html__("Behance Square", 'coyote'),
			"fa-bitbucket"          => esc_html__("Bitbucket", 'coyote'),
			"fa-bitcoin"            => esc_html__("Bitcoin", 'coyote'),
			"fa-btc"                => esc_html__("BTC", 'coyote'),
			"fa-css3"               => esc_html__("CSS3", 'coyote'),
			"fa-dribbble"           => esc_html__("Dribbble", 'coyote'),
			"fa-dropbox"            => esc_html__("Dropbox", 'coyote'),
			"fa-facebook"           => esc_html__("Facebook", 'coyote'),
			"fa-flickr"             => esc_html__("Flickr", 'coyote'),
			"fa-foursquare"         => esc_html__("Foursquare", 'coyote'),
			"fa-github"             => esc_html__("GitHub", 'coyote'),
			"fa-github-alt"         => esc_html__("GitHub-Alt", 'coyote'),
			"fa-gittip"             => esc_html__("Gittip", 'coyote'),
			"fa-google-plus"        => esc_html__("Google Plus", 'coyote'),
			"fa-html5"              => esc_html__("HTML5", 'coyote'),
			"fa-instagram"          => esc_html__("Instagram", 'coyote'),
			"fa-linkedin"           => esc_html__("LinkedIn", 'coyote'),
			"fa-linux"              => esc_html__("Linux", 'coyote'),
			"fa-envelope" 			=> esc_html__("Mail", 'coyote'),
			"fa-envelope-o" 		=> esc_html__("Mail Alt", 'coyote'),
			"fa-envelope-square" 	=> esc_html__("Mail Square", 'coyote'),
			"fa-maxcdn"             => esc_html__("MaxCDN", 'coyote'),
			"fa-paypal"             => esc_html__("Paypal", 'coyote'),
			"fa-pinterest"          => esc_html__("Pinterest", 'coyote'),
			"fa-renren"             => esc_html__("Renren", 'coyote'),
			"fa-skype"              => esc_html__("Skype", 'coyote'),
			"fa-stack-exchange"     => esc_html__("StackExchange", 'coyote'),
			"fa-tripadvisor"		=> esc_html__("Trip Advisor", 'coyote'),
			"fa-trello"             => esc_html__("Trello", 'coyote'),
			"fa-tumblr"             => esc_html__("Tumblr", 'coyote'),
			"fa-twitter"            => esc_html__("Twitter", 'coyote'),
			"fa-vimeo"				=> esc_html__("Vimeo", 'coyote'),
			"fa-vimeo-square"		=> esc_html__("Vimeo Square", 'coyote'),
			"fa-vine"				=> esc_html__("Vine", 'coyote'),
			"fa-vk"                 => esc_html__("VK", 'coyote'),
			"fa-weibo"              => esc_html__("Weibo", 'coyote'),
			"fa-wikipedia-w"		=> esc_html__("Wikipedia", 'coyote'),
			"fa-windows"            => esc_html__("Windows", 'coyote'),
			"fa-wordpress"			=> esc_html__("WordPress", 'coyote'),
			"fa-xing"               => esc_html__("Xing", 'coyote'),
			"fa-youtube"            => esc_html__("YouTube", 'coyote'),
			"fa-youtube-square"     => esc_html__("YouTube Square", 'coyote'),
			"fa-youtube-play"       => esc_html__("YouTube Play", 'coyote'),
		);
	}
