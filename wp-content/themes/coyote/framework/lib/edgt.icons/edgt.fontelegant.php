...
class CoyoteEdgeIconsFontElegant implements iCoyoteEdgeIconCollection {
    ...
    private function setSocialIconsArray() {
		...
		$this->socialIcons = array(
			"" => "",
			"social_blogger" => esc_html__("Blogger", 'coyote'),
			"social_blogger_circle" => esc_html__("Blogger circle", 'coyote'),
			"social_blogger_square" => esc_html__("Blogger square", 'coyote'),
			"social_delicious" => esc_html__("Delicious", 'coyote'),
			"social_delicious_circle" => esc_html__("Delicious circle", 'coyote'),
			"social_delicious_square" => esc_html__("Delicious square", 'coyote'),
			"social_deviantart" => esc_html__("Deviantart", 'coyote'),
			"social_deviantart_circle" => esc_html__("Deviantart circle", 'coyote'),
			"social_deviantart_square" => esc_html__("Deviantart square", 'coyote'),
			"social_dribbble" => esc_html__("Dribbble", 'coyote'),
			"social_dribbble_circle" => esc_html__("Dribbble circle", 'coyote'),
			"social_dribbble_square" => esc_html__("Dribbble square", 'coyote'),
			"social_facebook" => esc_html__("Facebook", 'coyote'),
			"social_facebook_circle" => esc_html__("Facebook circle", 'coyote'),
			"social_facebook_square" => esc_html__("Facebook square", 'coyote'),
			"social_flickr" => esc_html__("Flickr", 'coyote'),
			"social_flickr_circle" => esc_html__("Flickr circle", 'coyote'),
			"social_flickr_square" => esc_html__("Flickr square", 'coyote'),
			"social_googledrive" => esc_html__("Googledrive", 'coyote'),
			"social_googledrive_alt2" => esc_html__("Googledrive alt2", 'coyote'),
			"social_googledrive_square" => esc_html__("Googledrive square", 'coyote'),
			"social_googleplus" => esc_html__("Googleplus", 'coyote'),
			"social_googleplus_circle" => esc_html__("Googleplus circle", 'coyote'),
			"social_googleplus_square" => esc_html__("Googleplus square", 'coyote'),
			"social_instagram" => esc_html__("Instagram", 'coyote'),
			"social_instagram_circle" => esc_html__("Instagram circle", 'coyote'),
			"social_instagram_square" => esc_html__("Instagram square", 'coyote'),
			"social_linkedin" => esc_html__("Linkedin", 'coyote'),
			"social_linkedin_circle" => esc_html__("Linkedin circle", 'coyote'),
			"social_linkedin_square" => esc_html__("Linkedin square", 'coyote'),
			"social_myspace" => esc_html__("Myspace", 'coyote'),
			"social_myspace_circle" => esc_html__("myspace circle", 'coyote'),
			"social_myspace_square" => esc_html__("myspace square", 'coyote'),
			"social_picassa" => esc_html__("Picassa", 'coyote'),
			"social_picassa_circle" => esc_html__("Picassa circle", 'coyote'),
			"social_picassa_square" => esc_html__("Picassa square", 'coyote'),
			"social_pinterest" => esc_html__("Pinterest", 'coyote'),
			"social_pinterest_circle" => esc_html__("Pinterest circle", 'coyote'),
			"social_pinterest_square" => esc_html__("Pinterest square", 'coyote'),
			"social_rss" => esc_html__("Rss", 'coyote'),
			"social_rss_circle" => esc_html__("Rss circle", 'coyote'),
			"social_rss_square" => esc_html__("Rss square", 'coyote'),
			"social_share" => esc_html__("Share", 'coyote'),
			"social_share_circle" => esc_html__("Share circle", 'coyote'),
			"social_share_square" => esc_html__("Share square", 'coyote'),
			"social_skype" => esc_html__("Skype", 'coyote'),
			"social_skype_circle" => esc_html__("Skype circle", 'coyote'),
			"social_skype_square" => esc_html__("Skype square", 'coyote'),
			"social_spotify" => esc_html__("Spotify", 'coyote'),
			"social_spotify_circle" => esc_html__("Spotify circle", 'coyote'),
			"social_spotify_square" => esc_html__("Spotify square", 'coyote'),
			"social_stumbleupon_circle" => esc_html__("Stumbleupon circle", 'coyote'),
			"social_stumbleupon_square" => esc_html__("Stumbleupon square", 'coyote'),
			"social_tumbleupon" => esc_html__("Stumbleupon", 'coyote'),
			"social_tumblr" => esc_html__("Tumblr", 'coyote'),
			"social_tumblr_circle" => esc_html__("Tumblr circle", 'coyote'),
			"social_tumblr_square" => esc_html__("Tumblr square", 'coyote'),
			"social_twitter" => esc_html__("Twitter", 'coyote'),
			"social_twitter_circle" => esc_html__("Twitter circle", 'coyote'),
			"social_twitter_square" => esc_html__("Twitter square", 'coyote'),
			"social_vimeo" => esc_html__("Vimeo", 'coyote'),
			"social_vimeo_circle" => esc_html__("Vimeo circle", 'coyote'),
			"social_vimeo_square" => esc_html__("Vimeo square", 'coyote'),
			"social_wordpress" => esc_html__("WordPress", 'coyote'),
			"social_wordpress_circle" => esc_html__("WordPress circle", 'coyote'),
			"social_wordpress_square" => esc_html__("WordPress square", 'coyote'),
			"social_youtube" => esc_html__("Youtube", 'coyote'),
			"social_youtube_circle" => esc_html__("Youtube circle", 'coyote'),
			"social_youtube_square" => esc_html__("Youtube square", 'coyote'),
		);
	}
