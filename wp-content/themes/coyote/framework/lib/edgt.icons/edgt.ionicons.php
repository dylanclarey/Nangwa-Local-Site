...
class CoyoteEdgeIonIcons implements iCoyoteEdgeIconCollection {
	...
	private function setSocialIconsArray() {
		...
		$this->socialIcons = array(
			'' => '',
			'ion-social-android' => esc_html__('Android', 'coyote'),
			'ion-social-android-outline' => esc_html__('Android outline', 'coyote'),
			'ion-social-angular' => esc_html__('Angular', 'coyote'),
			'ion-social-angular-outline' => esc_html__('Angular outline', 'coyote'),
			'ion-social-apple' => esc_html__('Apple', 'coyote'),
			'ion-social-apple-outline' => esc_html__('Apple outline', 'coyote'),
			'ion-social-bitcoin' => esc_html__('Bitcoin', 'coyote'),
			'ion-social-bitcoin-outline' => esc_html__('Bitcoin outline', 'coyote'),
			'ion-social-buffer' => esc_html__('Buffer', 'coyote'),
			'ion-social-buffer-outline' => esc_html__('Buffer outline', 'coyote'),
			'ion-social-chrome' => esc_html__('Chrome', 'coyote'),
			'ion-social-chrome-outline' => esc_html__('Chrome outline', 'coyote'),
			'ion-social-codepen' => esc_html__('Codepen', 'coyote'),
			'ion-social-codepen-outline' => esc_html__('Codepen outline', 'coyote'),
			'ion-social-css3' => esc_html__('CSS3', 'coyote'),
			'ion-social-css3-outline' => esc_html__('CSS3 outline', 'coyote'),
			'ion-social-designernews' => esc_html__('Designernews', 'coyote'),
			'ion-social-designernews-outline' => esc_html__('Designernews outline', 'coyote'),
			'ion-social-dribbble' => esc_html__('Dribbble', 'coyote'),
			'ion-social-dribbble-outline' => esc_html__('Dribbble outline', 'coyote'),
			'ion-social-dropbox' => esc_html__('Dropbox', 'coyote'),
			'ion-social-dropbox-outline' => esc_html__('Dropbox outline', 'coyote'),
			'ion-social-euro' => esc_html__('Euro', 'coyote'),
			'ion-social-euro-outline' => esc_html__('Euro outline', 'coyote'),
			'ion-social-facebook' => esc_html__('Facebook', 'coyote'),
			'ion-social-facebook-outline' => esc_html__('Facebook outline', 'coyote'),
			'ion-social-foursquare' => esc_html__('Foursquare', 'coyote'),
			'ion-social-foursquare-outline' => esc_html__('Foursquare outline', 'coyote'),
			'ion-social-freebsd-devil' => esc_html__('Freebsd devil', 'coyote'),
			'ion-social-github' => esc_html__('Github', 'coyote'),
			'ion-social-github-outline' => esc_html__('Github outline', 'coyote'),
			'ion-social-google' => esc_html__('Google', 'coyote'),
			'ion-social-google-outline' => esc_html__('Google outline', 'coyote'),
			'ion-social-googleplus' => esc_html__('Google plus', 'coyote'),
			'ion-social-googleplus-outline' => esc_html__('Google plus outline', 'coyote'),
			'ion-social-hackernews' => esc_html__('Hackernews', 'coyote'),
			'ion-social-hackernews-outline' => esc_html__('Hackernews outline', 'coyote'),
			'ion-social-html5' => esc_html__('HTML5', 'coyote'),
			'ion-social-html5-outline' => esc_html__('HTML5 outline', 'coyote'),
			'ion-social-instagram' => esc_html__('Instagram', 'coyote'),
			'ion-social-instagram-outline' => esc_html__('Instagram outline', 'coyote'),
			'ion-social-javascript' => esc_html__('Java Script', 'coyote'),
			'ion-social-javascript-outline' => esc_html__('Java Script outline', 'coyote'),
			'ion-social-linkedin' => esc_html__('Linkedin', 'coyote'),
			'ion-social-linkedin-outline' => esc_html__('Linkedin outline', 'coyote'),
			'ion-social-markdown' => esc_html__('Markdown', 'coyote'),
			'ion-social-nodejs' => esc_html__('Node.js', 'coyote'),
			'ion-social-octocat' => esc_html__('Octocat', 'coyote'),
			'ion-social-pinterest' => esc_html__('Pinterest', 'coyote'),
			'ion-social-pinterest-outline' => esc_html__('Pinterest outline', 'coyote'),
			'ion-social-python' => esc_html__('Python', 'coyote'),
			'ion-social-reddit' => esc_html__('Reddit', 'coyote'),
			'ion-social-reddit-outline' => esc_html__('Reddit outline', 'coyote'),
			'ion-social-rss' => esc_html__('RSS', 'coyote'),
			'ion-social-rss-outline' => esc_html__('RSS outline', 'coyote'),
			'ion-social-sass' => esc_html__('sass', 'coyote'),
			'ion-social-skype' => esc_html__('Skype', 'coyote'),
			'ion-social-skype-outline' => esc_html__('Skype outline', 'coyote'),
			'ion-social-snapchat' => esc_html__('Snapchat', 'coyote'),
			'ion-social-snapchat-outline' => esc_html__('Snapchat outline', 'coyote'),
			'ion-social-tumblr' => esc_html__('Tumblr', 'coyote'),
			'ion-social-tumblr-outline' => esc_html__('Tumblr outline', 'coyote'),
			'ion-social-tux' => esc_html__('Tux', 'coyote'),
			'ion-social-twitch' => esc_html__('Twitch', 'coyote'),
			'ion-social-twitch-outline' => esc_html__('Twitch outline', 'coyote'),
			'ion-social-twitter' => esc_html__('Twitter', 'coyote'),
			'ion-social-twitter-outline' => esc_html__('Twitter outline', 'coyote'),
			'ion-social-usd' => esc_html__('USD', 'coyote'),
			'ion-social-usd-outline' => esc_html__('USD outline', 'coyote'),
			'ion-social-vimeo' => esc_html__('Vimeo', 'coyote'),
			'ion-social-vimeo-outline' => esc_html__('Vimeo outline', 'coyote'),
			'ion-social-whatsapp' => esc_html__('Whatsapp', 'coyote'),
			'ion-social-whatsapp-outline' => esc_html__('Whatsapp outline', 'coyote'),
			'ion-social-windows' => esc_html__('Windows', 'coyote'),
			'ion-social-windows-outline' => esc_html__('Windows outline', 'coyote'),
			'ion-social-wordpress' => esc_html__('WordPress', 'coyote'),
			'ion-social-wordpress-outline' => esc_html__('WordPress outline', 'coyote'),
			'ion-social-yahoo' => esc_html__('Yahoo', 'coyote'),
			'ion-social-yahoo-outline' => esc_html__('Yahoo outline', 'coyote'),
			'ion-social-yen' => esc_html__('Yen', 'coyote'),
			'ion-social-yen-outline' => esc_html__('Yen outline', 'coyote'),
			'ion-social-youtube' => esc_html__('Youtube', 'coyote'),
			'ion-social-youtube-outline' => esc_html__('Youtube outline', 'coyote'),
		);
	}
