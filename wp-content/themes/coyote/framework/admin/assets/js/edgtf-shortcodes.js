				...
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[edgtf_dropcaps type="' + e.data.type + '" color="' + e.data.color + '" background_color="' + e.data.background_color + '" border_style="' + e.data.border_style +'" thickness="' + e.data.thickness +'" border_color="' + e.data.border_color + '"]'+ e.data.letter +'[/edgtf_dropcaps]');
							}
						});
					}
				},
