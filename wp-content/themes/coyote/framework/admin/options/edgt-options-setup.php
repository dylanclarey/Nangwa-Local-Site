...
add_action('after_setup_theme', 'coyote_edge_admin_map_init', 0);

function coyote_edge_admin_map_init() {

    do_action('coyote_edge_before_options_map');
    ...
    do_action('coyote_edge_options_map');

    do_action('coyote_edge_after_options_map');
