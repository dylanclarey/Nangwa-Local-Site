<div class="edgtf-page-header page-header clearfix">
    ...
    <div class="edgtf-theme-name pull-left" >
        <img src="<?php echo esc_url(coyote_edge_get_skin_uri() . '/assets/img/logo.png'); ?>" alt="edgt_logo" class="edgtf-header-logo pull-left"/>
        ...
        <div class="edgtf-top-section-holder-inner">
            ...
            <div class="edgtf-top-buttons-holder">
                <?php if($show_save_btn) { ?>
                    <input type="button" id="edgt_top_save_button" class="btn btn-info btn-sm" value="<?php esc_html_e('Save Changes', 'coyote'); ?>"/>
                <?php } ?>
            </div>
