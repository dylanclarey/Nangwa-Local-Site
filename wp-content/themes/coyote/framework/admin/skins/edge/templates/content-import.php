                        ...
                        <div class="edgtf-page-form-section-holder">
                            ...
                            <div class="edgtf-page-form-section">
                                ...
                                <div class="edgtf-section-content">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="import_load"><span><?php esc_html_e('The import process may take some time. Please be patient.', 'coyote') ?> </span><br />
                            ...
                            <div class="edgtf-page-form-section edgtf-import-button-wrapper">
                                ...
                                <div class="alert alert-warning">
                                    ...
                                    <ul>
                                        <li><?php esc_html_e('Please note that import process will take time needed to download all attachments from demo web site.', 'coyote'); ?></li>
                                        <li> <?php esc_html_e('If you plan to use shop, please install WooCommerce before you run import.', 'coyote')?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            $(document).on('click', '#import_demo_data', function(e) {
                ...
                if (confirm('Are you sure, you want to import Demo Data now?')) {
                    ...
                    if(import_opt == 'content'){
                        for(var i=1;i<10;i++){
                            var str;
                            if (i < 10) str = 'coyote_content_0'+i+'.xml';
                            else str = 'coyote_content_'+i+'.xml';
                            jQuery.ajax({
                                type: 'POST',
                                url: ajaxurl,
                                data: {
